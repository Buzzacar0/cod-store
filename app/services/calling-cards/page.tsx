    ...
    <div className="min-h-screen bg-black">
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-white mb-4">🏆 CARTÕES DE VISITA</h1>
          <p className="text-gray-400 text-lg">🎯 Cartões de visita exclusivos para mostrar suas conquistas 💎</p>
        </div>

        {/* Centered single service */}
        <div className="flex justify-center max-w-6xl mx-auto">
          <div className="w-full max-w-sm">
            {callingCardServices.map((service) => (
              <Card
                key={service.id}
                className="bg-gray-900/50 border-gray-800 hover:border-purple-500/50 transition-all duration-300 group backdrop-blur-sm"
              >
                <CardHeader className="relative">
                  {service.popular && (
                    <Badge className="absolute top-4 right-4 bg-purple-500 text-white text-xs">
                  ...
                  <div className="aspect-video relative overflow-hidden rounded-lg mb-4 bg-gray-800">
                    ...
                    {/* Front Image with Motion Effects - Only Scale for Calling Cards */}
